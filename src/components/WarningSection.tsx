  ...
  return (
    <section className="py-12 sm:py-16 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <div className="bg-card shadow-elegant border border-border rounded-[2rem] p-6 sm:p-10 text-center shadow-elegant hover-lift animate-scale-in">
          ...
          <h3 className="text-2xl sm:text-3xl font-black text-foreground mb-4 sm:mb-6 px-2 animate-slide-up uppercase tracking-tighter italic">
            ⚠️ AVISO IMPORTANTE
          </h3>
          
          <p className="text-foreground/70 mb-8 text-base sm:text-lg px-2 animate-fade-in leading-relaxed font-medium" style={{animationDelay: '0.2s'}}>
          ...
          <div className="mb-8 bg-muted border border-border p-6 rounded-2xl shadow-soft animate-slide-up" style={{animationDelay: '0.4s'}}>
            ...
            <ul className="space-y-3 px-2 text-left max-w-md mx-auto">
              {warnings.map((warning, index) => (
                <li key={index} className="text-foreground text-base sm:text-lg flex items-center gap-3">
          ...
          <p className="text-foreground font-black text-lg sm:text-xl px-2 mt-2 uppercase italic tracking-widest animate-pulse">
