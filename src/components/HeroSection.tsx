...
export const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const baseUrl = "https://scripts.converteai.net/61a13f29-6abe-4749-8d01-cb0ec2e177c0/players/699e771285a22216bd6913d2/v4/embed.html";
  ...
  return <section className={`relative overflow-hidden bg-gradient-hero ${unlocked ? "pt-10 sm:pt-12 pb-0 sm:pb-1" : "py-10 sm:py-12"}`}>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-in mt-6 sm:mt-8 mb-0">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#ff2d9b] mb-6 sm:mb-8 leading-tight px-2 animate-slide-up drop-shadow-[0_0_15px_rgba(255,45,155,0.4)]">
            FRECUENCIA LÍMBICA
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-white mb-6 sm:mb-8 px-2 animate-slide-up" style={{
          animationDelay: '0.2s'
        }}>La Única Frecuencia Sonora Binaural que Hace que tu Ex Suplique Volver en hasta 7 días</p>

          {embedSrc && (
            <div id="ifr_699e771285a22216bd6913d2_wrapper" className="animate-fade-in" style={{ margin: "0 auto", width: "100%", maxWidth: 400 }}>
              <div id="ifr_699e771285a22216bd6913d2_aspect" style={{ position: "relative", padding: "176.47058823529412% 0 0 0" }}>
                <iframe
                  referrerPolicy="origin"
                  frameBorder={0}
                  allowFullScreen
                  id="ifr_699e771285a22216bd6913d2"
