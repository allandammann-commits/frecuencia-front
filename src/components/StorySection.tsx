  ...
  return (
    <section className="py-12 sm:py-16 px-4 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-20 left-10 w-32 h-32 bg-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '1.5s' }}></div>
      </div>
      
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-12 animate-fade-in">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-foreground mb-6 leading-tight px-2 uppercase tracking-tighter italic">
          ...
          <div className="mb-6 sm:mb-8">
            <img 
              ...
              className="w-48 sm:w-56 md:w-64 lg:w-72 h-auto mx-auto hover-lift animate-float shadow-elegant opacity-60 grayscale hover:grayscale-0 transition-all" 
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-10 items-start">
          <div className="space-y-8">
            <p className="text-lg sm:text-xl text-foreground/80 px-2 leading-relaxed font-medium">
            ...
            <div className="bg-card shadow-card border border-border rounded-3xl p-6 sm:p-8 hover-lift animate-slide-up" style={{ animationDelay: '0.3s' }}>
              ...
              <ul className="space-y-4">
                {painPoints.map((point, index) => (
                  <li key={index} className="text-foreground/80 text-base sm:text-lg flex items-start gap-3 italic font-medium">
          ...
          <div className="space-y-8">
            <div className="bg-primary/5 border border-primary/20 rounded-[2rem] p-8 sm:p-10 hover-glow animate-scale-in shadow-glow" style={{ animationDelay: '0.5s' }}>
              <p className="text-foreground text-base sm:text-lg font-medium mb-6 leading-relaxed">
              ...
              <p className="text-foreground text-lg sm:text-xl font-black italic border-l-4 border-primary pl-4">
