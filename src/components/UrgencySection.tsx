  ...
  return <section className="py-12 sm:py-16 md:py-20 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-6 sm:mb-8 animate-fade-in">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-foreground mb-4 px-2 leading-tight animate-slide-up drop-shadow-lg uppercase tracking-tighter italic">🔥 ÚLTIMAS 22 PLAZAS — ACCESO LIMITADO</h2>
        </div>
        
        <div className="bg-card shadow-card border border-border rounded-3xl p-6 sm:p-10 mb-8 hover-lift animate-scale-in" style={{
        animationDelay: '0.3s'
      }}>
          <p className="text-foreground/80 text-lg sm:text-xl mb-6 px-2 leading-relaxed font-medium">
          ...
          <div className="flex items-center justify-center space-x-2 sm:space-x-4 mb-6">
            ...
            <span className="text-xl sm:text-3xl font-black text-foreground uppercase tracking-tighter italic">Quedan pocas plazas para este mes.</span>
          </div>
          
          <p className="text-foreground/60 mb-4 text-base sm:text-lg px-2 italic font-medium">
