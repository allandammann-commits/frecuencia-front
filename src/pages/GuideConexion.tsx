  ...
  return (
    <div className="min-h-screen pb-24 px-4 pt-6 flex flex-col">
      <header className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl font-bold gradient-text mb-1">Conexión Energética</h1>
      ...
      <div className="glass-card rounded-2xl p-6 overflow-hidden">
        <p className="text-muted-foreground mb-4">
          Haz clic en el botón para descargar el eBook "Conexión Energética".
        </p>
        <a
          href="https://drive.google.com/file/d/15rpSowkA-niGzUryswP4HVJyztG2khRX/view?usp=sharing"
          target="_blank"
