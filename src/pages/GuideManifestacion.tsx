...
const GuideManifestacion = () => {
  const navigate = useNavigate();
  return (
    <div className="min-h-screen pb-24 px-4 pt-6 flex flex-col">
      <header className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-display text-3xl font-bold gradient-text mb-1">Manifestación Consciente</h1>
      ...
      <div className="glass-card rounded-2xl p-6 overflow-hidden">
        <p className="text-muted-foreground mb-4">
          Haz clic en el botón para descargar el eBook "Manifestación Consciente".
        </p>
        <a
          href="https://drive.google.com/file/d/1T7vinafAGlZyRL2gT1uegg6Wo4cYgopA/view?usp=sharing"
          target="_blank"
...
export default GuideManifestacion;